...
//    }
    ...
    void givenClass_AbleToUpdateClass() {
        var existingClass = new Class(1L, "code", "description", "subject", "status", "eudcation", Collections.emptyList(), Collections.emptyList(), OffsetDateTime.now(), OffsetDateTime.now());
